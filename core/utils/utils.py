...
def get_instance(module, name, config, **kwargs):
    # 不确定将来要往函数中传入多少个参数，即可使用可变参数（即不定长参数），用 * args, ** kwargs表示，当传入函数的参数为字典格式时，使用**kwargs。
    """
